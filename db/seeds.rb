...
conv1 = Conversation.create(subject: "Hello from Toronto", from: "", sender:"Tilo Mitra", last_message: "Hey, I just wanted to check in with you from Toronto. I got here earlier today.", color: "blue")
Message.create(
    content: "<p>
